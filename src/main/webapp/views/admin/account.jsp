...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/Admin/index/caterory" >
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/account/logout">Đăng xuất</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="accout/logout" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
						  ...
						  <tbody>
							  <c:forEach var="item" items="${items}">
							    <tr>							   
							      <td>${item.username }</td>
							      <td>${item.email }</td>
							      <td>${item.activated==true?'Hoạt động':'Không hoạt động' }</td>
							      <td>${item.admin==true?'Admin':'Khách hàng' }</td>
							      <td>${item.fullname }</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-4">
							<form:form action="/Admin/index/account" modelAttribute="item">							
								<div>
									...
									<div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                         <label for="my-input" class="col-sm-2 col-form-label">Tình trạng</label>
                                         <div class="col-sm-10">                                             
                                         <form:radiobuttons items="${activates}" path="activated" cssClass="form-control-input ml-2" name=""/>
                                         </div>
                                     </div>
                                     <div class="form-group row">
                                        <label for="my-input" class="col-sm-2 col-form-label">Vai trò</label>
                                        <div class="col-sm-10">                                             
									  ...
									  <div class="form-group row">
									    <div class="col row">
									      <button class="btn btn-success ml-1" formaction="/account/update"><i class="fas fa-edit"></i> Cập nhật</button>
									      <a class="btn btn-danger ml-auto" href="/account/delete/${item.username }"><i class="fas fa-trash-alt"></i> Xóa</a>
